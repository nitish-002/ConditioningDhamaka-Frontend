  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      try {
        ...
        const registerResponse = await fetch('hhttps://conditioningdhamakabackend.onrender.com/auth/register', {
          method: 'POST',
          headers: {
        ...
        if (!registerResponse.ok) {
          const loginResponse = await fetch('hhttps://conditioningdhamakabackend.onrender.com/auth/login', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json'
            },
