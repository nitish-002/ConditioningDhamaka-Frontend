          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 text-lg border border-gray-300 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
              />
      ...
      <div className="max-w-[1500px] mx-auto px-4 py-6">
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            {/* Remove old search bar location */}
